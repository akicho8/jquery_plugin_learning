  ...
  $.mbMiniPlayer={
    ...
    buildPlayer:function(options){
      ...
      if (navigator && navigator.platform && navigator.platform.match(/^(iPad|iPod|iPhone)$/)) {
        $.mbMiniPlayer.icon.play="<img src='images/mini_player/play.png'/>";
        $.mbMiniPlayer.icon.pause="<img src='images/mini_player/pause.png'/>";
        $.mbMiniPlayer.icon.stop="<img src='images/mini_player/stop.png'/>";
        $.mbMiniPlayer.icon.rewind="<img src='images/mini_player/rewind.png'/>";
        $.mbMiniPlayer.icon.volume="<img src='images/mini_player/volume.png'/>";
        $.mbMiniPlayer.icon.volumeMute="<img src='images/mini_player/volume.png'/>";
